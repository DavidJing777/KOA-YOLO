...
import torch
from ultralytics.my_model.MLCA import C2PSA_MLCA   #自己添加的模块
from ultralytics.my_model.SSA import C3k2_SSA    #自己添加的模块
from ultralytics.my_model.CMUNeXt import C3k2_CMUNeX,CMUNeXtBlock   #自己添加的模块
from ultralytics.my_model.PPA import C3k2_PPA   #自己添加的模块
from ultralytics.my_model.CRA import C3k2_CRA,C2PSA_CRA   #自己添加的模块
from ultralytics.my_model.Repconv import C3k2_RepVGG   #自己添加的模块
from ultralytics.my_model.Manhattan_SelfAttention import C2PSAPSABloc_VisionRetentionChunk   #自己添加的模块
    ...
    base_modules = frozenset(
        {
            ...
            C2PSA_CRA,    #自己添加模块
            C3k2_RepVGG,  #自己添加模块
            C2PSAPSABloc_VisionRetentionChunk,  # 自己添加模块
        }
    )
